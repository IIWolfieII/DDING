            ...
            <div class="container items-center px-8 mx-auto xl:px-5">
                <div class="flex flex-wrap flex-row items-center flex- sm:-mx-3 w-full">
                    ...
                    try {
                        ...
                        $apiRequest = $client->request('GET', 'https://www.bungie.net/platform/Destiny/Manifest/InventoryItem/1274330687/', $requestContent);
                    ...
                    for ($i = 0; $i <= 30; $i++) { ?>
                        <div class="rounded-sm h-16 w-16 m-1 cursor-pointer" style="background-image: url(https://www.bungie.net/{{ $item->icon }});"></div>
                    <?php } ?>
                </div>
            </div>
        </section>
