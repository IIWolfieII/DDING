<x-layout>
    <!-- Section 2 -->
    <section class="px-2 py-32 md:px-0 ml-4">
                ...
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                            ...
                            <span class="block text-red-600 xl:inline">Tell Your Story!</span>
                        </h1>
                        ...
                        <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                            <a href="#_" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-red-600 sm:mb-0 hover:bg-red-700 sm:w-auto rounded-lg">
                                Try It Free
                            ...
                            <a href="#_" class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 hover:bg-gray-200 hover:text-gray-600 rounded-lg">
                                Learn More
                            </a>
                        </div>
                    </div>
    ...
    <section class="relative">
        <div class="relative w-full bg-white px-5 py-10 mx-auto sm:py-12 md:py-16 md:px-10 max-w-7xl">

            <h1 class="mb-1 text-4xl font-extrabold leading-none lg:text-5xl xl:text-6xl sm:mb-3"><a href="#_">The Project Blog</a></h1>
