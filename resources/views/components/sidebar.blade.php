<div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600 fixed" style="">
  <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">DESTIding</h2>
