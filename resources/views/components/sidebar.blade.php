<div class="flex flex-col w-64 h-screen px-4 py-8 bg-white dark:bg-gray-800 dark:border-gray-600">
  <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">DDING</h2>
  ...
  <div class="flex flex-col justify-between flex-1 mt-6">
    ...
    <div class="flex items-center px-4 -mx-2">
      ...
      <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">IIWolfieII</h4>
    </div>
  </div>
</div>
